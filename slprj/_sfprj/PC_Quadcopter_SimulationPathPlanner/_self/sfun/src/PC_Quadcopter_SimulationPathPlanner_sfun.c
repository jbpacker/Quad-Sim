  ...
  nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2622882759U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(179271229U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2741443987U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2756411159U);
  }
  ...
  nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 2:
      {
        if (strcmp(aiChksum, "UKIoSuNppk5TRSkgWANLmC") == 0) {
          extern mxArray
  ...
  nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 2:
      {
        if (strcmp(tpChksum, "kMqcVYQmVc4WKXwlXkVWlH") == 0) {
          extern mxArray
