...
static void initialize_c2_kalmanTest(SFc2_kalmanTestInstanceStruct
  *chartInstance);
static void initialize_params_c2_kalmanTest(SFc2_kalmanTestInstanceStruct
  *chartInstance);
static void enable_c2_kalmanTest(SFc2_kalmanTestInstanceStruct *chartInstance);
static void disable_c2_kalmanTest(SFc2_kalmanTestInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_kalmanTest(SFc2_kalmanTestInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c2_kalmanTest(SFc2_kalmanTestInstanceStruct *
  chartInstance);
static void set_sim_state_c2_kalmanTest(SFc2_kalmanTestInstanceStruct
  *chartInstance, const mxArray *c2_st);
static void finalize_c2_kalmanTest(SFc2_kalmanTestInstanceStruct *chartInstance);
static void sf_gateway_c2_kalmanTest(SFc2_kalmanTestInstanceStruct
  *chartInstance);
static void c2_chartstep_c2_kalmanTest(SFc2_kalmanTestInstanceStruct
  *chartInstance);
static void initSimStructsc2_kalmanTest(SFc2_kalmanTestInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_kalmanTestInstanceStruct *chartInstance,
  const mxArray *c2_psi, const char_T *c2_identifier);
static real_T c2_b_emlrt_marshallIn(SFc2_kalmanTestInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_c_emlrt_marshallIn(SFc2_kalmanTestInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[3]);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_d_emlrt_marshallIn(SFc2_kalmanTestInstanceStruct *chartInstance,
...
static void c2_mpower(SFc2_kalmanTestInstanceStruct *chartInstance, real_T c2_a
                      [9], real_T c2_c[9]);
static void c2_inv3x3(SFc2_kalmanTestInstanceStruct *chartInstance, real_T c2_x
                      [9], real_T c2_y[9]);
static real_T c2_norm(SFc2_kalmanTestInstanceStruct *chartInstance, real_T c2_x
                      [9]);
static void c2_eml_warning(SFc2_kalmanTestInstanceStruct *chartInstance);
static void c2_b_eml_warning(SFc2_kalmanTestInstanceStruct *chartInstance,
  char_T c2_varargin_2[14]);
static void c2_eml_scalar_eg(SFc2_kalmanTestInstanceStruct *chartInstance);
static void c2_eml_xgemm(SFc2_kalmanTestInstanceStruct *chartInstance, real_T
  c2_A[9], real_T c2_B[3], real_T c2_C[3], real_T c2_b_C[3]);
static void c2_b_eml_scalar_eg(SFc2_kalmanTestInstanceStruct *chartInstance);
static void c2_eml_error(SFc2_kalmanTestInstanceStruct *chartInstance);
static void c2_b_eml_error(SFc2_kalmanTestInstanceStruct *chartInstance);
static void c2_e_emlrt_marshallIn(SFc2_kalmanTestInstanceStruct *chartInstance,
  const mxArray *c2_sprintf, const char_T *c2_identifier, char_T c2_y[14]);
static void c2_f_emlrt_marshallIn(SFc2_kalmanTestInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, char_T c2_y[14]);
static const mxArray *c2_d_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_g_emlrt_marshallIn(SFc2_kalmanTestInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_h_emlrt_marshallIn(SFc2_kalmanTestInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_kalmanTest, const char_T
  *c2_identifier);
static uint8_T c2_i_emlrt_marshallIn(SFc2_kalmanTestInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_eml_xgemm(SFc2_kalmanTestInstanceStruct *chartInstance, real_T
  c2_A[9], real_T c2_B[3], real_T c2_C[3]);
static void init_dsm_address_info(SFc2_kalmanTestInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_kalmanTest = 0U;
}
  ...
  chartInstance)
{
  ...
  c2_d_hoistedGlobal = chartInstance->c2_is_active_c2_kalmanTest;
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  *c2_theta = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u,
    2)), "theta");
  chartInstance->c2_is_active_c2_kalmanTest = c2_h_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 3)),
     "is_active_c2_kalmanTest");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_kalmanTest(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_kalmanTest(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  real_T c2_u;
  const mxArray *c2_y = NULL;
  SFc2_kalmanTestInstanceStruct *chartInstance;
  chartInstance = (SFc2_kalmanTestInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_kalmanTest_get_eml_resolved_functions_info(void)
{
...
static void c2_b_info_helper(const mxArray **c2_info)
{
  ...
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1286851120U), "fileTimeLo",
                  "fileTimeLo", 72);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 72);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/acos.m"), "resolved",
                  "resolved", 79);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1343862766U), "fileTimeLo",
                  "fileTimeLo", 79);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 79);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1343862776U), "fileTimeLo",
                  "fileTimeLo", 81);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 81);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  *c2_identifier)
{
  ...
  c2_y = c2_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_kalmanTest), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_kalmanTest);
  return c2_y;
}
...
void sf_c2_kalmanTest_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_kalmanTest_get_autoinheritance_info(void)
{
...
mxArray *sf_c2_kalmanTest_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_kalmanTest_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c2_kalmanTest(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[8],T\"psi\",},{M[1],M[13],T\"r\",},{M[1],M[7],T\"theta\",},{M[8],M[0],T\"is_active_c2_kalmanTest\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_kalmanTest_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_kalmanTestInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c2_kalmanTest(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_kalmanTestInstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c2_kalmanTest((SFc2_kalmanTestInstanceStruct*)
    chartInstanceVar);
  initialize_c2_kalmanTest((SFc2_kalmanTestInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_kalmanTest(void *chartInstanceVar)
{
  enable_c2_kalmanTest((SFc2_kalmanTestInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_kalmanTest(void *chartInstanceVar)
{
  disable_c2_kalmanTest((SFc2_kalmanTestInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_kalmanTest(void *chartInstanceVar)
{
  sf_gateway_c2_kalmanTest((SFc2_kalmanTestInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_kalmanTest(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_kalmanTest
    ((SFc2_kalmanTestInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_kalmanTest();/* state var info */
...
extern void sf_internal_set_sim_state_c2_kalmanTest(SimStruct* S, const mxArray *
  st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c2_kalmanTest();/* state var info */
  ...
  set_sim_state_c2_kalmanTest((SFc2_kalmanTestInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_kalmanTest(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_kalmanTest(S);
}

static void sf_opaque_set_sim_state_c2_kalmanTest(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c2_kalmanTest(S, st);
}

static void sf_opaque_terminate_c2_kalmanTest(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_kalmanTestInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c2_kalmanTest((SFc2_kalmanTestInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_kalmanTest((SFc2_kalmanTestInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_kalmanTest(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_kalmanTest(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(3068579675U));
  ssSetChecksum1(S,(2950990488U));
  ssSetChecksum2(S,(1537317450U));
  ssSetChecksum3(S,(4156146449U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_kalmanTest(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_kalmanTest(SimStruct *S)
{
  SFc2_kalmanTestInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_kalmanTestInstanceStruct *)utMalloc(sizeof
    (SFc2_kalmanTestInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_kalmanTestInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_kalmanTest;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c2_kalmanTest;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_kalmanTest;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_kalmanTest;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_kalmanTest;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c2_kalmanTest;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c2_kalmanTest;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c2_kalmanTest;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_kalmanTest;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_kalmanTest;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_kalmanTest;
...
void c2_kalmanTest_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_kalmanTest(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_kalmanTest(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_kalmanTest(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_kalmanTest_method_dispatcher.\n"
