...
static const char * c1_debug_family_names[17] = { "p_not_rot", "R", "p",
  "nargin", "nargout", "xq", "yq", "zq", "thetaq", "psiq", "phiq", "hx", "hy",
  "hz", "r", "theta", "psi" };

/* Function Declarations */
static void initialize_c1_PC_Quadcopter_SimulationPathPlanner
  (SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct *chartInstance);
static void initialize_params_c1_PC_Quadcopter_SimulationPathPlanner
  (SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct *chartInstance);
static void enable_c1_PC_Quadcopter_SimulationPathPlanner
  (SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct *chartInstance);
static void disable_c1_PC_Quadcopter_SimulationPathPlanner
  (SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_PC_Quadcopter_SimulationPathPlanner
  (SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_PC_Quadcopter_SimulationPathPlanner
  (SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct *chartInstance);
static void set_sim_state_c1_PC_Quadcopter_SimulationPathPlanner
  (SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct *chartInstance, const
   mxArray *c1_st);
static void finalize_c1_PC_Quadcopter_SimulationPathPlanner
  (SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct *chartInstance);
static void sf_gateway_c1_PC_Quadcopter_SimulationPathPlanner
  (SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct *chartInstance);
static void c1_chartstep_c1_PC_Quadcopter_SimulationPathPlanner
  (SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct *chartInstance);
static void initSimStructsc1_PC_Quadcopter_SimulationPathPlanner
  (SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct *chartInstance);
...
static real_T c1_emlrt_marshallIn
  (SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct *chartInstance, const
   mxArray *c1_psi, const char_T *c1_identifier);
...
static void c1_mpower(SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct
                      *chartInstance, real_T c1_a[9], real_T c1_c[9]);
static void c1_inv3x3(SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct
                      *chartInstance, real_T c1_x[9], real_T c1_y[9]);
static real_T c1_norm(SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct
                      *chartInstance, real_T c1_x[9]);
static void c1_eml_warning
  (SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct *chartInstance);
static void c1_b_eml_warning
  (SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct *chartInstance, char_T
   c1_varargin_2[14]);
static void c1_eml_scalar_eg
  (SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct *chartInstance);
static void c1_eml_xgemm(SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct *
  chartInstance, real_T c1_A[9], real_T c1_B[3], real_T c1_C[3], real_T c1_b_C[3]);
static void c1_b_eml_scalar_eg
  (SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct *chartInstance);
static void c1_eml_error(SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct *
  chartInstance);
static void c1_b_eml_error
  (SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct *chartInstance);
...
static uint8_T c1_h_emlrt_marshallIn
  (SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct *chartInstance, const
   mxArray *c1_b_is_active_c1_PC_Quadcopter_SimulationPathPlanner, const char_T *
   c1_identifier);
static uint8_T c1_i_emlrt_marshallIn
  (SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct *chartInstance, const
   mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_eml_xgemm
  (SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct *chartInstance, real_T
  ...
  (SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_PC_Quadcopter_SimulationPathPlanner = 0U;
}
  ...
  (SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct *chartInstance)
{
  ...
  c1_d_hoistedGlobal =
    chartInstance->c1_is_active_c1_PC_Quadcopter_SimulationPathPlanner;
   ...
   mxArray *c1_st)
{
  ...
  *c1_psi = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 0)),
    "psi");
  *c1_r = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 1)),
    "r");
  *c1_theta = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u,
  ...
  chartInstance->c1_is_active_c1_PC_Quadcopter_SimulationPathPlanner =
    ...
    "is_active_c1_PC_Quadcopter_SimulationPathPlanner");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_PC_Quadcopter_SimulationPathPlanner(chartInstance);
  ...
  (SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_sfEvent = CALL_EVENT;
  c1_chartstep_c1_PC_Quadcopter_SimulationPathPlanner(chartInstance);
  ...
  (SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c1_p_not_rot, 0U, c1_b_sf_marshallOut,
    c1_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c1_R, 1U, c1_c_sf_marshallOut,
    c1_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c1_p, 2U, c1_b_sf_marshallOut,
    c1_b_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_nargout, 4U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_xq, 5U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_yq, 6U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_zq, 7U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_thetaq, 8U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_psiq, 9U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_phiq, 10U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_hx, 11U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_hy, 12U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_hz, 13U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_r, 14U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_theta, 15U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_psi, 16U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  c1_R[0] = c1_b_x * c1_d_x;
  c1_R[3] = c1_f_x * c1_h_x * c1_j_x - c1_l_x * c1_n_x;
  c1_R[6] = c1_p_x * c1_r_x * c1_t_x + c1_v_x * c1_x_x;
  c1_R[1] = c1_ab_x * c1_cb_x;
  c1_R[4] = c1_eb_x * c1_gb_x * c1_ib_x + c1_kb_x * c1_mb_x;
  c1_R[7] = c1_ob_x * c1_qb_x * c1_sb_x - c1_ub_x * c1_wb_x;
  c1_R[2] = -c1_yb_x;
  c1_R[5] = c1_bc_x * c1_dc_x;
  c1_R[8] = c1_fc_x * c1_hc_x;
  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 10);
  for (c1_i0 = 0; c1_i0 < 9; c1_i0++) {
    c1_b_R[c1_i0] = c1_R[c1_i0];
  }

  c1_mpower(chartInstance, c1_b_R, c1_a);
  for (c1_i1 = 0; c1_i1 < 3; c1_i1++) {
    c1_b[c1_i1] = c1_p_not_rot[c1_i1];
  }
  ...
  for (c1_i4 = 0; c1_i4 < 9; c1_i4++) {
    c1_dv0[c1_i4] = c1_a[c1_i4];
  }

  for (c1_i5 = 0; c1_i5 < 3; c1_i5++) {
    c1_dv1[c1_i5] = c1_b[c1_i5];
  }

  for (c1_i6 = 0; c1_i6 < 9; c1_i6++) {
    c1_dv2[c1_i6] = c1_dv0[c1_i6];
  }

  for (c1_i7 = 0; c1_i7 < 3; c1_i7++) {
    c1_dv3[c1_i7] = c1_dv1[c1_i7];
  }

  c1_b_eml_xgemm(chartInstance, c1_dv2, c1_dv3, c1_p);
  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 20);
  for (c1_i8 = 0; c1_i8 < 3; c1_i8++) {
    c1_b[c1_i8] = c1_p[c1_i8];
  }

  for (c1_k = 0; c1_k < 3; c1_k++) {
    c1_b_k = 1.0 + (real_T)c1_k;
    c1_ak = c1_b[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
      c1_b_k), 1, 3, 1, 0) - 1];
    c1_b_a = c1_ak;
  ...
  c1_c_y = c1_b_y[0];
  for (c1_c_k = 2; c1_c_k < 4; c1_c_k++) {
    c1_d_k = c1_c_k;
    c1_c_y += c1_b_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK
      ("", (real_T)c1_d_k), 1, 3, 1, 0) - 1];
  }
  ...
  c1_e_y = c1_d_y;
  c1_lc_x = c1_kc_x;
  c1_theta = muDoubleScalarAtan2(c1_e_y, c1_lc_x);
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct *chartInstance;
  chartInstance = (SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct *)
    chartInstanceVoid;
   ...
   mxArray *c1_psi, const char_T *c1_identifier)
{
  ...
  c1_y = c1_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c1_psi), &c1_thisId);
  ...
  *c1_inData)
{
  ...
  for (c1_i14 = 0; c1_i14 < 3; c1_i14++) {
    for (c1_i15 = 0; c1_i15 < 3; c1_i15++) {
      c1_b_inData[c1_i15 + c1_i13] = (*(real_T (*)[9])c1_inData)[c1_i15 + c1_i13];
    }
  ...
  for (c1_i17 = 0; c1_i17 < 3; c1_i17++) {
    for (c1_i18 = 0; c1_i18 < 3; c1_i18++) {
      c1_u[c1_i18 + c1_i16] = c1_b_inData[c1_i18 + c1_i16];
    }
  ...
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  ...
  for (c1_i21 = 0; c1_i21 < 3; c1_i21++) {
    for (c1_i22 = 0; c1_i22 < 3; c1_i22++) {
      (*(real_T (*)[9])c1_outData)[c1_i22 + c1_i20] = c1_y[c1_i22 + c1_i20];
    }
  ...
  (void)
{
  ...
  sf_mex_assign(&c1_nameCaptureInfo, sf_mex_createstruct("structure", 2, 82, 1),
                false);
...
static void c1_info_helper(const mxArray **c1_info)
{
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/cos.m"), "resolved",
                  "resolved", 0);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1343862772U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_cos.m"),
                  "resolved", "resolved", 1);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1286851122U), "fileTimeLo",
                  "fileTimeLo", 1);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 1);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/sin.m"), "resolved",
                  "resolved", 2);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1343862786U), "fileTimeLo",
                  "fileTimeLo", 2);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 2);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_sin.m"),
                  "resolved", "resolved", 3);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1286851136U), "fileTimeLo",
                  "fileTimeLo", 3);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 3);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/inv.m"), "resolved",
                  "resolved", 10);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1305350400U), "fileTimeLo",
                  "fileTimeLo", 10);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 10);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/norm.m"), "resolved",
                  "resolved", 19);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1363742668U), "fileTimeLo",
                  "fileTimeLo", 19);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 19);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("power"), "name", "name", 46);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 46);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m!fltpower"), "context",
                  "context", 51);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("floor"), "name", "name", 51);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 51);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("sum"), "name", "name", 55);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 55);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/datafun/sum.m"), "context",
                  "context", 57);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("isequal"), "name", "name", 57);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 57);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
...
static void c1_b_info_helper(const mxArray **c1_info)
{
  ...
  sf_mex_addfield(*c1_info, sf_mex_duplicatearraysafe(&c1_lhs65), "lhs", "lhs",
                  65);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(""), "context", "context", 66);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("sqrt"), "name", "name", 66);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 66);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1286851138U), "fileTimeLo",
                  "fileTimeLo", 68);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 68);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c1_info, sf_mex_duplicatearraysafe(&c1_lhs68), "lhs", "lhs",
                  68);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(""), "context", "context", 69);
  ...
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1286851120U), "fileTimeLo",
                  "fileTimeLo", 72);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 72);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c1_info, sf_mex_duplicatearraysafe(&c1_lhs72), "lhs", "lhs",
                  72);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(""), "context", "context", 73);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("mrdivide"), "name", "name", 73);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 73);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "context",
                  "context", 75);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("rdivide"), "name", "name", 75);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 75);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m"), "context",
                  "context", 78);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("eml_div"), "name", "name", 78);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 78);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_div.m"), "resolved",
  ...
  sf_mex_addfield(*c1_info, sf_mex_duplicatearraysafe(&c1_lhs78), "lhs", "lhs",
                  78);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(""), "context", "context", 79);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("acos"), "name", "name", 79);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 79);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/acos.m"), "resolved",
                  "resolved", 79);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1343862766U), "fileTimeLo",
                  "fileTimeLo", 79);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 79);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1343862776U), "fileTimeLo",
                  "fileTimeLo", 81);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 81);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  (SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct *chartInstance)
{
  ...
  const mxArray *c1_y = NULL;
  (void)chartInstance;
  for (c1_i28 = 0; c1_i28 < 27; c1_i28++) {
    c1_u[c1_i28] = c1_varargin_1[c1_i28];
  }
  ...
  chartInstance, real_T c1_A[9], real_T c1_B[3], real_T c1_C[3], real_T c1_b_C[3])
{
  ...
  for (c1_i31 = 0; c1_i31 < 3; c1_i31++) {
    c1_b_C[c1_i31] = c1_C[c1_i31];
  }

  for (c1_i32 = 0; c1_i32 < 9; c1_i32++) {
    c1_b_A[c1_i32] = c1_A[c1_i32];
  }

  for (c1_i33 = 0; c1_i33 < 3; c1_i33++) {
    c1_b_B[c1_i33] = c1_B[c1_i33];
  }
   ...
   c1_identifier)
{
  ...
  c1_y = c1_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_PC_Quadcopter_SimulationPathPlanner), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_PC_Quadcopter_SimulationPathPlanner);
  return c1_y;
}
   ...
   c1_A[9], real_T c1_B[3], real_T c1_C[3])
{
  ...
  for (c1_i40 = 0; c1_i40 < 3; c1_i40++) {
    ...
    for (c1_i42 = 0; c1_i42 < 3; c1_i42++) {
      c1_C[c1_i40] += c1_A[c1_i41 + c1_i40] * c1_B[c1_i42];
      c1_i41 += 3;
    }
  }
}
...
void sf_c1_PC_Quadcopter_SimulationPathPlanner_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2523684103U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1011177068U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2531174427U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(4017621491U);
}

mxArray *sf_c1_PC_Quadcopter_SimulationPathPlanner_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("DBrhK5NAqyYRxXz6nMg5uB");
...
mxArray *sf_c1_PC_Quadcopter_SimulationPathPlanner_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_PC_Quadcopter_SimulationPathPlanner_updateBuildInfo_args_info
  (void)
{
...
static const mxArray
  *sf_get_sim_state_info_c1_PC_Quadcopter_SimulationPathPlanner(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[8],T\"psi\",},{M[1],M[13],T\"r\",},{M[1],M[7],T\"theta\",},{M[8],M[0],T\"is_active_c1_PC_Quadcopter_SimulationPathPlanner\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_PC_Quadcopter_SimulationPathPlanner_get_check_sum(&mxChecksum);
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1835);
...
{
  return "N5IrWP5huURc01ljDS4RYE";
}

static void sf_opaque_initialize_c1_PC_Quadcopter_SimulationPathPlanner(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct*) chartInstanceVar)
     ->S,0);
  initialize_params_c1_PC_Quadcopter_SimulationPathPlanner
    ((SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct*) chartInstanceVar);
  initialize_c1_PC_Quadcopter_SimulationPathPlanner
    ((SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_PC_Quadcopter_SimulationPathPlanner(void
  *chartInstanceVar)
{
  enable_c1_PC_Quadcopter_SimulationPathPlanner
    ((SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_PC_Quadcopter_SimulationPathPlanner(void
  *chartInstanceVar)
{
  disable_c1_PC_Quadcopter_SimulationPathPlanner
    ((SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_PC_Quadcopter_SimulationPathPlanner(void
  *chartInstanceVar)
{
  sf_gateway_c1_PC_Quadcopter_SimulationPathPlanner
    ((SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c1_PC_Quadcopter_SimulationPathPlanner(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_PC_Quadcopter_SimulationPathPlanner
    ((SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c1_PC_Quadcopter_SimulationPathPlanner();/* state var info */
...
extern void sf_internal_set_sim_state_c1_PC_Quadcopter_SimulationPathPlanner
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c1_PC_Quadcopter_SimulationPathPlanner
    ((SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c1_PC_Quadcopter_SimulationPathPlanner(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_PC_Quadcopter_SimulationPathPlanner(S);
}

static void sf_opaque_set_sim_state_c1_PC_Quadcopter_SimulationPathPlanner
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c1_PC_Quadcopter_SimulationPathPlanner(S, st);
}

static void sf_opaque_terminate_c1_PC_Quadcopter_SimulationPathPlanner(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c1_PC_Quadcopter_SimulationPathPlanner
      ((SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc1_PC_Quadcopter_SimulationPathPlanner
    ((SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_PC_Quadcopter_SimulationPathPlanner
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_PC_Quadcopter_SimulationPathPlanner(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
  ...
  ssSetChecksum0(S,(1281826953U));
  ssSetChecksum1(S,(3206716151U));
  ssSetChecksum2(S,(40198363U));
  ssSetChecksum3(S,(487147718U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c1_PC_Quadcopter_SimulationPathPlanner(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_PC_Quadcopter_SimulationPathPlanner(SimStruct *S)
{
  SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct *)
    utMalloc(sizeof(SFc1_PC_Quadcopter_SimulationPathPlannerInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_PC_Quadcopter_SimulationPathPlanner;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_PC_Quadcopter_SimulationPathPlanner;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_PC_Quadcopter_SimulationPathPlanner;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c1_PC_Quadcopter_SimulationPathPlanner;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_PC_Quadcopter_SimulationPathPlanner;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_PC_Quadcopter_SimulationPathPlanner;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_PC_Quadcopter_SimulationPathPlanner;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_PC_Quadcopter_SimulationPathPlanner;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c1_PC_Quadcopter_SimulationPathPlanner;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c1_PC_Quadcopter_SimulationPathPlanner;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_PC_Quadcopter_SimulationPathPlanner;
...
void c1_PC_Quadcopter_SimulationPathPlanner_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_PC_Quadcopter_SimulationPathPlanner(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_PC_Quadcopter_SimulationPathPlanner(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_PC_Quadcopter_SimulationPathPlanner(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_PC_Quadcopter_SimulationPathPlanner_method_dispatcher.\n"
