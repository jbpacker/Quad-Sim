...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1989281745U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1975498609U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1453509868U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1927873046U);
}
...
mxArray *sf_c2_PC_Quadcopter_SimulationPathPlanner_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("UKIoSuNppk5TRSkgWANLmC");
...
static void mdlSetWorkWidths_c2_PC_Quadcopter_SimulationPathPlanner(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1508140345U));
  ssSetChecksum1(S,(1216858172U));
  ssSetChecksum2(S,(2358109900U));
  ssSetChecksum3(S,(967212572U));
