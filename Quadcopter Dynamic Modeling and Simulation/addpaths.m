...
% or load a map from file - update map in Lidar/MATLAB Function and
% Camera/relativePosition simulink matlab functions
load('./Lidar/ObstacleMap/obstaclemap.mat'); % obstacle map
load('./Lidar/ObstacleMap/obstacleGroundTruth.mat');
% load('./Lidar/ObstacleMap/clearmap.mat');   % Clear map
% load('./Lidar/ObstacleMap/clearGroundTruth.mat');
